...
Mininet cho phép triển khai mạng thông qua API. Các chi nhánh LAN và mạng lõi được định nghĩa rõ ràng. Một điểm thiết kế nâng cao ở đồ án là xử lý \textbf{Vòng lặp mạng lớp 2 (L2 Loop)} tại Site C (Mạng Leaf-Spine).
...
mpls ldp
 ...
 address-family ipv4
  ...
  interface lo               ! Phat LDP tren cong Loopback
  interface {name}-eth0      ! Phat LDP tren cong noi vao Backbone
 !
!
line vty
!
