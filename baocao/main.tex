...
\begin{document}
	...
	{\let\oldnumberline\numberline
		\renewcommand{\numberline}[1]{Bảng~#1:\hspace{1.5em}}
		\listoftables}
...
\include{chuongs/chuong1_tongquan_lythuyet}       
\newpage
\clearpage

% Chương 2: Thiết kế Hệ thống và Quy hoạch
\include{chuongs/chuong2_thietke_quyhoach} 
\newpage
\clearpage

% Chương 3: Cấu hình và Triển khai kỹ thuật
\include{chuongs/chuong3_trienkhai_cauhinh}
\newpage
\clearpage
	
% Chương 4: Thực nghiệm và Đánh giá hiệu năng
\include{chuongs/chuong4_kiemthu_minhchung}
\newpage
\clearpage

% Chương 5: Phân tích kết quả và Kết luận
\include{chuongs/chuong5_danhgia_ketluan}
\newpage
\clearpage
        	
% \newpage
\clearpage
\include{chuongs/chuong6_tailieuthamkhao}
